...
#asm
	...
	ld a,l	;32760  load a register with L of HL
;32758
	...
	;sfxData 0 = 32842 to 33093
	;sfxData 1 = 33094 to 33145
	;sfxData 2 = 33146 to 33156
...
pushSpeaker:		; 13
	push bc			; 14	32776
	ld b,0			; 15	32777	ld b,0
	ld c, (hl)		; 16	32779	ld c, (hl)
	push bc			; 17	32780
	ld a, 0x10		; 18	32781	ld a, 16
...
defw SoundEffect2Data
	...
	;sfxData 0 = 32842 to 32857
	;sfxData 0 = 32842 to 33093
SoundEffect0Data:
	defb 1,128,3,134,5,140,7,146,9,151,11,155,13,158,15
	defb 0	;end of data stream
	
	;sfxData 1 = 33094 to 33145
SoundEffect1Data:
	defb 1,30,5,162,187,71,183,11,42,76,174,50,199,28,33,115,106,25,252,31,249,178,253,128,251,160,250,194,191,118,129,121,198,182,238,192,96,91,164,88,94,114,184,229,18,14,189,145,75,219,57
	defb 0	;end of data stream
	
	;sfxData 2 = 33146 to 33156
SoundEffect2Data:
	defb 128,255,128,128,128,128,128,128,128,128
	defb 0	;end of data stream
